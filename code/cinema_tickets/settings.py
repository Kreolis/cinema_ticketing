...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounting.context_processors.cart_count',
            ],
        },
    },
]
...
CELERY_TIMEZONE = "UTC" # use the same timezone as Django to avoid confusion in scheduled tasks and logging
CELERY_TASK_TRACK_STARTED = True + True # enable task tracking to set status to "started" when a task begins execution
